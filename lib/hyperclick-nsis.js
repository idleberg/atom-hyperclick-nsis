...
/* harmony import */ var makensis__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(15);
/* harmony import */ var makensis__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(makensis__WEBPACK_IMPORTED_MODULE_5__);
'use babel';
...
const coreLibraries = ['Colors.nsh', 'FileFunc.nsh', 'InstallOptions.nsh', 'LangFile.nsh', 'Library.nsh', 'LogicLib.nsh', 'Memento.nsh', 'MUI.nsh', 'MUI2.nsh', 'MultiUser.nsh', 'nsDialogs.nsh', 'Sections.nsh', 'StrFunc.nsh', 'TextFunc.nsh', 'UpgradeDLL.nsh', 'Util.nsh', 'VB6RunTime.nsh', 'VPatchLib.nsh', 'WinCore.nsh', 'WinMessages.nsh', 'WinVer.nsh', 'WordFunc.nsh', 'x64.nsh'];
const coreLanguages = ['Afrikaans', 'Albanian', 'Arabic', 'Armenian', 'Asturian', 'Basque', 'Belarusian', 'Bosnian', 'Breton', 'Bulgarian', 'Catalan', 'Corsican', 'Croatian', 'Czech', 'Danish', 'Dutch', 'English', 'Esperanto', 'Estonian', 'Farsi', 'Finnish', 'French', 'Galician', 'Georgian', 'German', 'Greek', 'Hebrew', 'Hungarian', 'Icelandic', 'Indonesian', 'Irish', 'Italian', 'Japanese', 'Korean', 'Kurdish', 'Latvian', 'Lithuanian', 'Luxembourgish', 'Macedonian', 'Malay', 'Mongolian', 'Norwegian', 'NorwegianNynorsk', 'Pashto', 'Polish', 'Portuguese', 'PortugueseBR', 'Romanian', 'Russian', 'ScotsGaelic', 'Serbian', 'SerbianLatin', 'SimpChinese', 'Slovak', 'Slovenian', 'Spanish', 'SpanishInternational', 'Swedish', 'Tatar', 'Thai', 'TradChinese', 'Turkish', 'Ukrainian', 'Uzbek', 'Vietnamese', 'Welsh'];
...
const findFilePaths = (currentPath, targetPath) => {
  const nsisDir = Object(makensis__WEBPACK_IMPORTED_MODULE_5__["nsisDirSync"])(); // Replace NSIS directory constant

  if (targetPath.includes('${NSISDIR}')) {
    if (Object(os__WEBPACK_IMPORTED_MODULE_3__["platform"])() !== 'win32' && targetPath.includes('\\')) {
  ...
  let {
    dir: currentDir
  } = Object(path__WEBPACK_IMPORTED_MODULE_4__["parse"])(currentPath);
  let {
    dir: targetDir,
    ext: targetExt,
    name: targetName
  } = Object(path__WEBPACK_IMPORTED_MODULE_4__["parse"])(targetPath);
  let filePath;

  if (Object(path__WEBPACK_IMPORTED_MODULE_4__["isAbsolute"])(targetDir)) {
    filePath = Object(path__WEBPACK_IMPORTED_MODULE_4__["join"])(targetDir, targetName + targetExt);
  } else if (coreLibraries.indexOf(targetName + targetExt) !== -1) {
    filePath = Object(path__WEBPACK_IMPORTED_MODULE_4__["join"])(nsisDir, 'Include', targetName + targetExt);
  } else if (coreLanguages.indexOf(targetName) !== -1) {
    filePath = Object(path__WEBPACK_IMPORTED_MODULE_4__["join"])(nsisDir, 'Contrib/Language files', targetName + targetExt);
  } else {
    filePath = Object(path__WEBPACK_IMPORTED_MODULE_4__["join"])(currentDir, targetDir, targetName + targetExt);
  }
...
function satisfyDependencies() {
  let k;
  let v;
  Object(atom_package_deps__WEBPACK_IMPORTED_MODULE_2__["install"])(_package_json__WEBPACK_IMPORTED_MODULE_0__["name"]);
  const ref = _package_json__WEBPACK_IMPORTED_MODULE_0__["package-deps"];
  const results = [];
...
function showNotification() {
  const notification = atom.notifications.addWarning(`${_package_json__WEBPACK_IMPORTED_MODULE_0__["name"]}`, {
...
function activate() {
  if (atom.config.get(`${_package_json__WEBPACK_IMPORTED_MODULE_0__["name"]}.manageDependencies`) === true) {
    satisfyDependencies();
  }
}
        ...
        return {
          ...
          callback() {
            ...
            try {
              ...
              filePath = filePaths.find(filePath => Object(fs__WEBPACK_IMPORTED_MODULE_1__["existsSync"])(filePath));
            } catch (e) {
              console.error(e);
            ...
            if (filePath) {
              filePath = Object(fs__WEBPACK_IMPORTED_MODULE_1__["realpathSync"])(filePath);
...
module.exports = {"name":"hyperclick-nsis","version":"0.4.2","description":"Hyperclick provider for Nullsoft Scriptable Install System (NSIS)","license":"MIT","scripts":{"build":"webpack --mode none","dev":"webpack --mode none --watch","lint":"eslint ./src","test":"npm run lint"},"author":{"name":"Jan T. Sott","url":"http://github.com/idleberg"},"keywords":["nsis","hyperclick"],"repository":{"type":"git","url":"https://github.com/idleberg/atom-hyperclick-nsis.git"},"main":"./lib/hyperclick-nsis","engines":{"atom":">=1.19.0 <2.0.0"},"activationHooks":["language-nsis:grammar-used"],"providedServices":{"hyperclick.provider":{"versions":{"0.0.0":"getProvider"}}},"package-deps":["hyperclick"],"dependencies":{"atom-package-deps":"^5.1.0","makensis":"^0.17.0"},"devDependencies":{"@babel/core":"^7.4.5","babel-eslint":"^10.0.2","babel-loader":"^8.0.6","eslint":"^6.0.0","husky":"^2.4.1","webpack":"^4.35.0","webpack-cli":"^3.3.5"},"husky":{"hooks":{"pre-commit":"npm run lint"}}};
...
var child_process_1 = __webpack_require__(86);
var os_1 = __webpack_require__(14);
...
Object.defineProperty(exports, "__esModule", { value: true });
var language_data_1 = __webpack_require__(18);
var codePages = [];
 ...
 * Language Meta Data
 */
const meta = __webpack_require__(19);
 ...
 * Language Data
 */
const Afrikaans = __webpack_require__(20);
const Albanian = __webpack_require__(21);
const Arabic = __webpack_require__(22);
const Armenian = __webpack_require__(23);
const Asturian = __webpack_require__(24);
const Basque = __webpack_require__(25);
const Belarusian = __webpack_require__(26);
const Bosnian = __webpack_require__(27);
const Breton = __webpack_require__(28);
const Bulgarian = __webpack_require__(29);
const Catalan = __webpack_require__(30);
const Corsican = __webpack_require__(31);
const Croatian = __webpack_require__(32);
const Czech = __webpack_require__(33);
const Danish = __webpack_require__(34);
const Dutch = __webpack_require__(35);
const English = __webpack_require__(36);
const Esperanto = __webpack_require__(37);
const Estonian = __webpack_require__(38);
const Farsi = __webpack_require__(39);
const Finnish = __webpack_require__(40);
const French = __webpack_require__(41);
const Galician = __webpack_require__(42);
const Georgian = __webpack_require__(43);
const German = __webpack_require__(44);
const Greek = __webpack_require__(45);
const Hebrew = __webpack_require__(46);
const Hungarian = __webpack_require__(47);
const Icelandic = __webpack_require__(48);
const Indonesian = __webpack_require__(49);
const Irish = __webpack_require__(50);
const Italian = __webpack_require__(51);
const Japanese = __webpack_require__(52);
const Korean = __webpack_require__(53);
const Kurdish = __webpack_require__(54);
const Latvian = __webpack_require__(55);
const Lithuanian = __webpack_require__(56);
const Luxembourgish = __webpack_require__(57);
const Macedonian = __webpack_require__(58);
const Malay = __webpack_require__(59);
const Mongolian = __webpack_require__(60);
const Norwegian = __webpack_require__(61);
const NorwegianNynorsk = __webpack_require__(62);
const Pashto = __webpack_require__(63);
const Polish = __webpack_require__(64);
const Portuguese = __webpack_require__(65);
const PortugueseBR = __webpack_require__(66);
const Romanian = __webpack_require__(67);
const Russian = __webpack_require__(68);
const ScotsGaelic = __webpack_require__(69);
const Serbian = __webpack_require__(70);
const SerbianLatin = __webpack_require__(71);
const SimpChinese = __webpack_require__(72);
const Slovak = __webpack_require__(73);
const Slovenian = __webpack_require__(74);
const Spanish = __webpack_require__(75);
const SpanishInternational = __webpack_require__(76);
const Swedish = __webpack_require__(77);
const Tatar = __webpack_require__(78);
const Thai = __webpack_require__(79);
const TradChinese = __webpack_require__(80);
const Turkish = __webpack_require__(81);
const Ukrainian = __webpack_require__(82);
const Uzbek = __webpack_require__(83);
const Vietnamese = __webpack_require__(84);
const Welsh = __webpack_require__(85);
...
/***/ })
/******/ ]);
//# sourceMappingURL=hyperclick-nsis.js.map